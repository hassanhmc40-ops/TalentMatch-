# Recommendation UX Spec

## Purpose

Define reusable Blade components for rendering structured recommendations with consistent color coding, icons, and layout. Centralizes the recommendation → variant/label/icon mapping to eliminate duplication across views.
