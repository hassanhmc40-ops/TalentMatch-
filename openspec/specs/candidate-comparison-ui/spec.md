...
Define the dedicated candidate comparison view for the TalentMatch HR assistant, enabling side-by-side comparison of two candidates analyzed for the same job offer.
