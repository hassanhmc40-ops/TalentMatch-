...
The `AnalyseCvJob` SHALL build a French-language prompt containing the candidate's CV text and the job offer's title, description, required skills, and minimum experience.
