...
Add charts, filterable recent analyses table, and score distribution visualization to the TalentMatch dashboard to give HR agents quick insight into their candidate pool.
