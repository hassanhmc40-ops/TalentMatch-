...
Define the multi-dimensional weighted scoring, verdict logic, and skill gap analysis for the candidate comparison feature used by the conversational agent.
...
- Experience score: consider tuning the under-experience penalty and over-experience decay rate based on real usage patterns.
- Skills coverage: consider comparing against the offer's required skills rather than just between the two candidates.
