...
HR agents need to see an overview of all their job offers to decide which ones need attention and navigate to the next step in the workflow. This capability covers a paginated listing page that shows key details for each offer and scopes the list to the authenticated user.
