...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-primary-500 text-sm font-medium leading-5 text-neutral-900 focus:outline-none focus:border-primary-700 transition duration-150 ease-in-out'
